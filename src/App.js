    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button onClick = { () => setHomeScore(homeScore - homeScore) }className="homeButtons__fieldGoal">Score Reset</button>
        </div>
        <div className="awayButtons">
          ...
          <button onClick = { () => setAwayScore(awayScore - awayScore) }className="awayButtons__fieldGoal">Score Reset</button>
        </div>
      </section>
    </div>
  );
